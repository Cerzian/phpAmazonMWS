...
abstract class AmazonCore{
     ...
     */
    protected function __construct($s = null, $mock = false, $m = null, $store = [], MerchantConfig $merchantConfig, ClientConfig $clientConfig) {
        $this->loadFromConfig($merchantConfig, $clientConfig);
...
<ErrorResponse xmlns="http://mws.amazonaws.com/doc/2009-01-01/">
  ...
  <RequestID>123</RequestID>
    ...
    protected function loadFromConfig(MerchantConfig $merchantConfig, ClientConfig $clientConfig)
    {
        $this->options['AWSAccessKeyId'] = $clientConfig->getAwsKeyId();
        $this->secret = $clientConfig->getSecretKey();
        $this->options['SellerId'] = $merchantConfig->getSellerId();
        $this->options['MarketplaceId'] = $merchantConfig->getMarketplaceId();
        $this->options['MWSAuthToken'] = $merchantConfig->getMwsToken();
        $this->baseUrl = $merchantConfig->getServiceUrl();
    }
